...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String,String>> handleNoteAlreadyExistsException(NoteAlreadyExistsException ex){
        log.warn("Note already exist {}", ex.getMessage());
        Map<String,String> errors = new HashMap<>();
        errors.put("message", "Note already exists");
        return ResponseEntity.badRequest().body(errors);
    }
